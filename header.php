    ...
    <body>
        ...
        <div id="wrapper">
            <div id="header" class="gfx">
                    <div id="logo"><div id="title"><a class="title" href="<?php echo home_url(); ?>"><?php bloginfo('name'); ?></a> <a class="description" href="<?php echo home_url(); ?>"><?php bloginfo('description'); ?></a></div>
                    <!DOCTYPE svg PUBLIC "-//W3C//DTD SVG 1.1//EN" "http://www.w3.org/Graphics/SVG/1.1/DTD/svg11.dtd">


                    
                    <div class="logo-<?php echo ICL_LANGUAGE_CODE ?>"></div></div>
                    <div id="print-logo">
